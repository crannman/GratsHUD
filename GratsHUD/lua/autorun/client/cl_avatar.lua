...
local a = vgui.Create("AvatarMask", parent)
    a:SetSize(ScrW() * .052, ScrH() * .095)
    a:SetPos(ScrW() * .01, ScrH() * .88 )
    a:SetMouseInputEnabled(false)



hook.Add("InitPostEntity", "SetAvatarPlayer", function()
	a:SetPlayer( LocalPlayer(), 128 )
end)
